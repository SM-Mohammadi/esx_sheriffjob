...
AddEventHandler('esx_sheriff_job:giveWeapon', function(weapon, ammo)
	...
	if xPlayer.job.name == 'sheriff' then
		...
		print(('esx_sheriff_job: %s attempted to give weapon!'):format(xPlayer.identifier))
	end
end)
...
AddEventHandler('esx_sheriff_job:confiscatePlayerItem', function(target, itemType, itemName, amount)
	...
	if sourceXPlayer.job.name ~= 'sheriff' then
		print(('esx_sheriff_job: %s attempted to confiscate!'):format(xPlayer.identifier))
		return
	end
...
RegisterServerEvent('esx_sheriff_job:handcuff')
AddEventHandler('esx_sheriff_job:handcuff', function(target)
	local xPlayer = ESX.GetPlayerFromId(source)

	if xPlayer.job.name == 'sheriff' then
		TriggerClientEvent('esx_sheriff_job:handcuff', target)
	else
		print(('esx_sheriff_job: %s attempted to handcuff a player (not cop)!'):format(xPlayer.identifier))
	end
end)
...
AddEventHandler('esx_sheriff_job:drag', function(target)
	...
	if xPlayer.job.name == 'sheriff' then
		...
		print(('esx_sheriff_job: %s attempted to drag (not cop)!'):format(xPlayer.identifier))
	end
end)
...
AddEventHandler('esx_sheriff_job:putInVehicle', function(target)
	...
	if xPlayer.job.name == 'sheriff' then
		...
		print(('esx_sheriff_job: %s attempted to put in vehicle (not cop)!'):format(xPlayer.identifier))
	end
end)
...
AddEventHandler('esx_sheriff_job:OutVehicle', function(target)
	...
	if xPlayer.job.name == 'sheriff' then
		...
		print(('esx_sheriff_job: %s attempted to drag out from vehicle (not cop)!'):format(xPlayer.identifier))
	end
end)
...
AddEventHandler('playerDropped', function()
	...
	if _source ~= nil then
		...
		if xPlayer ~= nil and xPlayer.job ~= nil and xPlayer.job.name == 'sheriff' then
			Citizen.Wait(5000)
			TriggerClientEvent('esx_sheriff_job:updateBlip', -1)
		end
	end	
end)

RegisterServerEvent('esx_sheriff_job:spawned')
AddEventHandler('esx_sheriff_job:spawned', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
...
RegisterServerEvent('esx_sheriff_job:forceBlip')
AddEventHandler('esx_sheriff_job:forceBlip', function()
	TriggerClientEvent('esx_sheriff_job:updateBlip', -1)
end)
...
RegisterServerEvent('esx_sheriff_job:message')
AddEventHandler('esx_sheriff_job:message', function(target, msg)
