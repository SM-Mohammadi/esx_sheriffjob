...
function OpenCloakroomMenu()
	...
	if grade == 'agent' then
		table.insert(elements, {label = _U('sheriff_wear'), value = 'agent_wear'})
	elseif grade == 'special' then
		table.insert(elements, {label = _U('sheriff_wear'), value = 'special_wear'})
	elseif grade == 'supervisor' then
		table.insert(elements, {label = _U('sheriff_wear'), value = 'supervisor_wear'})
	elseif grade == 'assistant' then
		table.insert(elements, {label = _U('sheriff_wear'), value = 'assistant_wear'})
			...
			if Config.MaxInService ~= -1 then
				...
				ESX.TriggerServerCallback('esx_service:isInService', function(isInService)
					if isInService then
						...
						TriggerEvent('esx_sheriff_job:updateBlip')
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'citizen_interaction', {
				...
				if closestPlayer ~= -1 and closestDistance <= 3.0 then
					...
					elseif action == 'body_search' then
						TriggerServerEvent('esx_sheriff_job:message', GetPlayerServerId(closestPlayer), _U('being_searched'))
						OpenBodySearchMenu(closestPlayer)
					elseif action == 'handcuff' then
						TriggerServerEvent('esx_sheriff_job:handcuff', GetPlayerServerId(closestPlayer))
...
function ShowPlayerLicense(player)
	...
	ESX.TriggerServerCallback('esx_sheriff_job:getOtherPlayerData', function(data)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'manage_license', {
			...
			TriggerServerEvent('esx_sheriff_job:message', GetPlayerServerId(player), _U('license_revoked', data.current.label))
...
RegisterNetEvent('esx_sheriff_job:handcuff')
AddEventHandler('esx_sheriff_job:handcuff', function()
...
RegisterNetEvent('esx_sheriff_job:unrestrain')
AddEventHandler('esx_sheriff_job:unrestrain', function()
	if IsHandcuffed then
		local playerPed = PlayerPedId()
		IsHandcuffed = false
...
RegisterNetEvent('esx_sheriff_job:updateBlip')
AddEventHandler('esx_sheriff_job:updateBlip', function()
...
AddEventHandler('playerSpawned', function(spawn)
	isDead = false
	TriggerEvent('esx_sheriff_job:unrestrain')
